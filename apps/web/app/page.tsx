  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-2xl border ${
        highlight ? "border-amber-500/60" : "border-zinc-800"
      }`}
    >
      ...
      <div className="relative p-5">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <Link
            href={`/round/${round.id}`}
            className="rounded-lg bg-amber-500 px-4 py-2 font-black text-zinc-950 shadow-lg shadow-amber-500/20 transition hover:bg-amber-400 hover:shadow-amber-400/40"
          >
            Pull Up
          </Link>
        </div>
